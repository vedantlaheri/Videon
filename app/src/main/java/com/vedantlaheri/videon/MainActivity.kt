...
import com.vedantlaheri.videon.MainActivity.Companion.folderList
import com.vedantlaheri.videon.MainActivity.Companion.themeIndex
import com.vedantlaheri.videon.MainActivity.Companion.videoList
import com.vedantlaheri.videon.databinding.ActivityMainBinding
import com.vedantlaheri.videon.databinding.ThemeViewBinding
            ...
            when (it.itemId) {
                R.id.themesNav -> {
                    ...
                    when (themeIndex) {
                        ...
                        1 -> bindingTV.themePurple.setBackgroundColor(Color.YELLOW)
                        2 -> bindingTV.themeGreen.setBackgroundColor(Color.YELLOW)
                        3 -> bindingTV.themeRed.setBackgroundColor(Color.YELLOW)
                        4 -> bindingTV.themeBlack.setBackgroundColor(Color.YELLOW)
                    }
                    bindingTV.themeBlue.setOnClickListener { saveTheme(0) }
                    bindingTV.themePurple.setOnClickListener { saveTheme(1) }
                    bindingTV.themeGreen.setOnClickListener { saveTheme(2) }
                    bindingTV.themeRed.setOnClickListener { saveTheme(3) }
                    bindingTV.themeBlack.setOnClickListener { saveTheme(4) }
                }
                R.id.sortOrderNav -> {
...
//                ActivityCompat.requestPermissions(this, arrayOf(READ_EXTERNAL_STORAGE),14)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        val gradientList = arrayOf(R.drawable.blue_gradient, R.drawable.purple_gradient, R.drawable.green_gradient
