...
public final class NavHeaderBinding implements ViewBinding {
  ...
  private NavHeaderBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout gradientLayout) {
  ...
  public static NavHeaderBinding bind(@NonNull View rootView) {
    ...
    LinearLayout gradientLayout = (LinearLayout) rootView;

    return new NavHeaderBinding((LinearLayout) rootView, gradientLayout);
  }
}
